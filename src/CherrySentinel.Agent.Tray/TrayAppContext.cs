...
{
    private const string ServiceName = "CherrySentinelAgent";
    private const string LogDir = @"C:\ProgramData\CherrySentinel\Agent\logs";
    ...
    public TrayAppContext(string installDir)
    {
        ...
        _menu.Items.Add(new ToolStripLabel($"Cherry Sentinel Agent  v{trayVer}")
        {
    ...
    private async Task TestCentralAsync()
    {
        try
        {
            ...
            if (resp.IsSuccessStatusCode)
            {
                MessageBox.Show(
                    ...
                    "Cherry Sentinel", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            else
            {
                MessageBox.Show(
        ...
        catch (Exception ex)
        {
            MessageBox.Show(
                ...
                ex.Message,
                "Cherry Sentinel", MessageBoxButtons.OK, MessageBoxIcon.Error);
        }
    }
    ...
    private Icon LoadIcon()
    {
        ...
        var paths = new[]
        {
            Path.Combine(_installDir, "CherrySentinel.ico"),
            Path.Combine(AppContext.BaseDirectory, "CherrySentinel.ico"),
            Path.Combine(AppContext.BaseDirectory, "Assets", "CherrySentinel.ico")
        };
    ...
    private void RefreshStatus()
    {
        ...
        var tip = live.ServiceRunning
            ? $"Cherry Sentinel v{trayVer} | {live.Host}"
            : $"Cherry Sentinel v{trayVer} | {live.ServiceStatus}";
    ...
    private static void OpenFolder(string path)
    {
        ...
        {
            MessageBox.Show(ex.Message, "Cherry Sentinel", MessageBoxButtons.OK, MessageBoxIcon.Warning);
        }
    }
