...
namespace CherrySentinel.Server.Security;

/// <summary>
/// Validates X-Cherry-Api-Key when Security:RequireAuth=true.
/// Sets HttpContext.Items: CherryAuthPrincipal (operator|agent|anonymous), CherryAgentId.
/// </summary>
public sealed class ApiKeyAuthMiddleware
{
    public const string PrincipalItem = "CherryAuthPrincipal";
    public const string AgentIdItem = "CherryAgentId";
