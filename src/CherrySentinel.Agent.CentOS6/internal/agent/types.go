...
import (
	...
	"github.com/paddman/CherrySentinelAgent/src/CherrySentinel.Agent.CentOS6/internal/collector"
	"github.com/paddman/CherrySentinelAgent/src/CherrySentinel.Agent.CentOS6/internal/config"
	"github.com/paddman/CherrySentinelAgent/src/CherrySentinel.Agent.CentOS6/internal/model"
	"github.com/paddman/CherrySentinelAgent/src/CherrySentinel.Agent.CentOS6/internal/parser"
	"github.com/paddman/CherrySentinelAgent/src/CherrySentinel.Agent.CentOS6/internal/spool"
	"github.com/paddman/CherrySentinelAgent/src/CherrySentinel.Agent.CentOS6/internal/transport"
)
...
func New(cfg config.Config, version, executablePath string, logger *log.Logger) (*Agent, error) {
	...
	client, err := transport.New(cfg.Central, filepath.Join(cfg.Paths.StateDir, "agent-api-key"), "CherrySentinel-Agent-CentOS6/"+version)
	if err != nil {
		return nil, err
	}
