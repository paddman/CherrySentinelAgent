...
Cherry Sentinel now has a deployable **Sovereign AI-XDR / SOC-as-a-Service** layer under [`ai-service/`](ai-service/README.md).
...
Full architecture and dashboard integration: [`docs/sentinel-brain-ai.md`](docs/sentinel-brain-ai.md).
