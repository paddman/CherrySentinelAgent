...
| Package | File |
|---------|------|
| Full stack | `CherrySentinel-Setup-1.1.0.exe` |
| Agent only | `CherrySentinel-Agent-Setup-1.1.0.exe` |
| Central only | `CherrySentinel-Central-Setup-1.1.0.exe` |
| Linux Agent | `CherrySentinel-Linux-Agent-1.1.0-linux-x64.tar.gz` |
