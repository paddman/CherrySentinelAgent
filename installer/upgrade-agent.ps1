...
param(
    ...
    [string]$InstallDir = "C:\Program Files\CherrySentinel\Agent",
    [string]$DataDir = "C:\ProgramData\CherrySentinel\Agent",
    [string]$ServiceName = "CherrySentinelAgent",
    [string]$CentralUrl = ""
)

$ErrorActionPreference = "Stop"
Write-Host "== Cherry Sentinel Agent Upgrade ==" -ForegroundColor Cyan

$exe = Join-Path $SourceDir "CherrySentinel.Agent.exe"
...
$backupConfig = Join-Path $env:TEMP "cherrysentinel-appsettings.backup.json"
