...
namespace CherrySentinel.Gui
{
    public partial class MainWindow : Window
    {
        ...
        private void Action_Click(object sender, RoutedEventArgs e) => MessageBox.Show("ตัวอย่าง UI เท่านั้น: เชื่อมปุ่มนี้กับ Response API ของ Cherry Sentinel Agent", "Cherry Sentinel Agent", MessageBoxButton.OK, MessageBoxImage.Information);
    }
